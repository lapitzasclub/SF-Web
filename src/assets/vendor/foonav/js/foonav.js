...
FooNav.Instance = function (options) {
	...
	this.init = function (o) {
		...
		if (_.o.smart.enable) {
			if (_.o.smart.url) {
				_.m.set(location.href, _.o.smart.open);
			}
			if (_.o.smart.close) {
				$(window).on('click', _.w.clicked);
			}
			if (_.o.smart.anchors) {
	...
	this.u = {
		...
		supportsTransitions: function () {
			if (_.u._supportsTransitions != null) {
				return _.u._supportsTransitions;
			}
			...
			for (var i = 0; i < v.length; i++) {
				if (typeof s[v[i] + p] == 'string') {
					return _.u._supportsTransitions = true;
				}
			}
	...
	this.b = {
		...
		buttons: function () {
			...
			function _icon(name) {
				...
				if (!i) return $();
				return $('<span></span>', {
					'class': _.u.concat('fon-button-icon', i.family, i.icon)
				});
			}
		...
		menu: function () {
			...
			function _icon(name) {
				...
				if (!i) return $();
				return $('<span></span>', {
					'class': _.u.concat('fon-item-icon', i.family, i.icon)
				});
			}
		 ...
		 */
		extra: function () {
			if (_.o.before != null) _.nav.prepend($('<div></div>', {
				'class': 'fon-before'
			}).append(_.o.before));
			if (_.o.after != null) _.nav.append($('<div></div>', {
				'class': 'fon-after'
			}).append(_.o.after));
		}
	};
	...
	this.a = {
		...
		tracked: {
			 ...
			 */
			get: function () {
				if (_.a.tracked.elements.length > 0) {
			...
			_.a._check.start(function () {
				...
				if (st <= _.o.scroll) {
					...
					for (i = 0; i < tracked.length; i++) {
						if (!_.a.visible(tracked[i].get(0))) {
							continue;
						}
	...
	this.w = {
		...
		scroll: function (target) {
			_.a._check.stop();
			var $target = $(target);
			var top = $target.offset() !== undefined ? $target.offset().top : 0;
		...
		scrolled: function () {
			_.w._scrolled.start(function () {
				...
				if (_.o.top) {
					if (st > 0) {
						_.top.addClass('fon-show');
					} else {
						_.top.removeClass('fon-show');
					}
